...
export const JUZ_STARTING_POSITIONS: Record<number, { surahId: number; verseNumber: number }> = {
  1: { surahId: 1, verseNumber: 1 },
  2: { surahId: 2, verseNumber: 142 },
  3: { surahId: 2, verseNumber: 253 },
  4: { surahId: 3, verseNumber: 93 },
  5: { surahId: 4, verseNumber: 24 },
  6: { surahId: 4, verseNumber: 148 },
  7: { surahId: 5, verseNumber: 82 },
  8: { surahId: 6, verseNumber: 111 },
  9: { surahId: 7, verseNumber: 88 },
  10: { surahId: 8, verseNumber: 41 },
  11: { surahId: 9, verseNumber: 93 },
  12: { surahId: 11, verseNumber: 6 },
  13: { surahId: 12, verseNumber: 53 },
  14: { surahId: 15, verseNumber: 1 },
  15: { surahId: 17, verseNumber: 1 },
  16: { surahId: 18, verseNumber: 75 },
  17: { surahId: 21, verseNumber: 1 },
  18: { surahId: 23, verseNumber: 1 },
  19: { surahId: 25, verseNumber: 21 },
  20: { surahId: 27, verseNumber: 56 },
  21: { surahId: 29, verseNumber: 46 },
  22: { surahId: 33, verseNumber: 31 },
  23: { surahId: 36, verseNumber: 28 },
  24: { surahId: 39, verseNumber: 32 },
  25: { surahId: 41, verseNumber: 47 },
  26: { surahId: 46, verseNumber: 1 },
  27: { surahId: 51, verseNumber: 31 },
  28: { surahId: 58, verseNumber: 1 },
  29: { surahId: 67, verseNumber: 1 },
  30: { surahId: 78, verseNumber: 1 }
};

export function getAbsoluteAyah(surahId: number, verseNumber: number): number {
...
export function calculateNextReview(rating: "hard" | "medium" | "easy" | "mastered", currentInterval: number = 0): {
  ...
  switch (rating) {
    ...
    case "easy":
      ...
      break;
    case "mastered":
      // If was already mastered, double the interval up to 30 days maximum
