          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 flex flex-col justify-between">
              ...
              <p className="text-xs text-slate-400 mt-2 font-medium">
                {(progress?.currentStreak || 0) > 0 ? (hasReadToday() ? `حافظت على وردك ${progress?.currentStreak} يومًا متتاليًا` : 'أكمل مهمة اليوم للحفاظ على سلسلتك') : 'ابدأ سلسلتك اليوم بخطوة واحدة'}
              </p>
            </div>
          </div>
